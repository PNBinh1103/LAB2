 ...
 * @author tai.tran
 */
public class Q2_LAB2b_Bank {

    ArrayList<Q2_LAB2a_BankAccount> listAcc = new ArrayList<>();

    public Q2_LAB2b_Bank() {
    }

    public void Input() {
        Scanner obj = new Scanner(System.in);
        int n;
        System.out.print("Input N AccoutBank: ");
        n = obj.nextInt();
        for (int i = 0; i < n; i++) {
            Q2_LAB2a_BankAccount acc = new Q2_LAB2a_BankAccount();
            acc.Input(obj);
            listAcc.add(acc);
        }
    }
    ...
    public void TranferMoney() {
        ...
        Q2_LAB2a_BankAccount acc1 = null, acc2 = null;
        for (int i = 0; i < listAcc.size(); i++) {
            if (listAcc.get(i).CompareAccoutNumber(accNumber)) {
