 ...
 * @author Student
 */
public class Q2_LAB2a_BankAccount {
    private int mAccNum;
    private String mName;
    private double mBalance;
    public Q2_LAB2a_BankAccount() {
    }
    public Q2_LAB2a_BankAccount(int mAccNum, String mName, double mBalance) {
   ...
   public void Input(Scanner obj)
    ...
    public boolean TranferMoney(Q2_LAB2a_BankAccount acc, double money)
    {
        if(money<=0) return false;
        if(money>this.mBalance) return false;
        this.Withdraw(money);
